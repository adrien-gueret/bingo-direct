...
export const messages = {
  fr: {
    ...
    imageLabel: "Image",
    imageLayout: "Affichage de l’image",
    imageBackground: "Image en fond",
    imageAbove: "Image au-dessus du texte",
    imageFit: "Cadrage de l’image",
    imageCover: "Remplir le cadre",
    imageCoverHint: "Les bords peuvent être coupés.",
    imageContain: "Afficher l’image entière",
    imageContainHint: "Des marges peuvent apparaître.",
    cellPreview: "Aperçu de la cellule",
    imagePosition: "Position de l’image",
    imageDragHint: "Fais glisser l’image pour la décaler.",
    imagePositionKeyboard: "Utilise les flèches du clavier pour déplacer l’image, ou la touche Début pour la recentrer.",
  ...
  en: {
    ...
    imageFit: "Image framing",
    imageCover: "Fill the frame",
    imageCoverHint: "Edges may be cropped.",
    imageContain: "Show the whole image",
    imageContainHint: "Margins may appear.",
    cellPreview: "Cell preview",
    imagePosition: "Image position",
    imageDragHint: "Drag the image to reposition it.",
    imagePositionKeyboard: "Use the arrow keys to move the image, or Home to center it.",
